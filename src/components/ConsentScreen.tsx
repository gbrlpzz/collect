    ...
    <main className="auth-page">
      ...
      >
        ...
        <p className="consent-lede">
          Your observations become research evidence. Read how they are
          recorded.
        </p>
        <div className="consent-text" tabIndex={0}>
          {text}
        </div>
        <p className="consent-version">
          Consent statement v{version} · accepted on your contributor profile
        </p>
        <button
